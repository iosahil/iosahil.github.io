...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            root: ["projects", "personal-documents", "skills", "languages", "PDPU", "interests"],
            PDPU: ["Sem-6"],
            ...
            skills: ["Front-end development", "React.js", "Python", "Kotlin", "C","C++", "SQL", "Sketch Artist","Photography"],
            projects: ["The Awesomize Project", "EzWhatsapp"],
            interests: ["Software Engineering", "Deep Learning", "Cyber Security"],
            languages: ["Javascript", "C++", "Java", "Python", "Kotlin"],
        };
        this.state = {
            terminal: [],
        }
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">sahil@Lenovo</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/sahil")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-sahil, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-sahil":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-sahil");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-sahil, trash, settings, sendmsg ]";
                }
                break;
